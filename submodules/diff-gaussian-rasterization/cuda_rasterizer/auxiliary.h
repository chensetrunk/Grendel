...
// TODO: check the correctness of this function; it has not been used yet.
__forceinline__ __host__ __device__ void getLocalPixelRect(uint2& local_pixel_rect_min, uint2& local_pixel_rect_max, unsigned int image_width, unsigned int image_height, dim3 grid, int local_rank, int world_size)
{
